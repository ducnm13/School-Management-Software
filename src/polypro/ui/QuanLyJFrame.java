...
public class QuanLyJFrame extends javax.swing.JFrame {
    ...
    void openNhanVien() {
        try {
            if (ShareHelper.USER.getVaitro() && ShareHelper.authenticated()) {
                new NhanVienJFrame().setVisible(true);
            } else {
                DialogHelper.alert(this, "Bạn không cô quyền truy cập thông tin này!!");
            }
        } catch (Exception e) {
    ...
    private void initComponents() {
        ...
        lblKhoahoc.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        lblKhoahoc.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblKhoahoc.setText("Khoá Học");
        getContentPane().add(lblKhoahoc, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 520, -1, -1));
        ...
        getContentPane().add(lblNhanvien, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 520, -1, -1));
        ...
        btnNhanvien.setIcon(new javax.swing.ImageIcon(getClass().getResource("/polypro/icon/img/Main/icons8_permanent_job_96px.png"))); // NOI18N
        ...
        getContentPane().add(btnNhanvien, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 360, -1, -1));

        btnKhoahoc.setIcon(new javax.swing.ImageIcon(getClass().getResource("/polypro/icon/img/Main/icons8_contract_80px.png"))); // NOI18N
        ...
        getContentPane().add(btnKhoahoc, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 373, -1, 150));

        btnChuyende.setIcon(new javax.swing.ImageIcon(getClass().getResource("/polypro/icon/img/Main/icons8_book_96px_2.png"))); // NOI18N
    ...
    private void btnThongkeMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnThongkeMouseClicked
        ...
        DialogHelper.alert(this, "Vui lòng nhấn trở lại để thao tác!!");
